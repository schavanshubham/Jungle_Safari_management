...
import javax.persistence.Table;
	...
	public class AdminPackage  {
		...
		public AdminPackage(int pkg_id, String pkg_name, Date validity_date, int pkg_price_frgn, int pkg_price_ind,
		...
		public String toString() {
			return "AdminPackage [pkg_id=" + pkg_id + ", pkg_name=" + pkg_name + ", validity_date=" + validity_date
